...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.mathjax', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinxcontrib.youtube']
...
htmlhelp_basename = 'Optioncomplmentaireinformatiqueprogrammationdoc'
...
latex_documents = [
  ('index', 'Optioncomplmentaireinformatiqueprogrammation.tex', u'Option complémentaire informatique : programmation',
